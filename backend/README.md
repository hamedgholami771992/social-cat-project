...
running inside the local os:
    ...
    - run "npm run migration:generate-init" to generate the initMigration for creating tables
    - run "npm run migration:run" to execute the migrations
    - if you changes the database schemas, you have to run 
       "npm run migration:generate: to execute the migration
       then run "npm run migration:run" to execute the migration to the database
